...
<head>
    ...
    <title>Reset Password - Valencia Dial</title>
        ...
        <div class="animate__animated animate__fadeInLeft hidden md:flex md:col-span-5 p-12 lg:p-16 flex-col justify-between relative border-r bg-[#0a0a0f]" style="border-color: rgba(255,255,255,0.05);">
            ...
            <div class="relative z-10 space-y-5 my-auto">
                <h2 class="font-serif text-3xl lg:text-4xl text-white/90 font-medium leading-tight tracking-wide">
                    Restore <br>Access To <br><span class="gold">Excellence</span>.
                </h2>
                <div class="w-12 h-[1px] gold-bg"></div>
                <p class="text-white/40 text-xs font-light leading-relaxed tracking-wide max-w-xs">
                    Establish a new cryptic passkey to re-verify your authorization. Make sure your credentials remain confidential to preserve absolute account security.
                </p>
            </div>
        ...
        <div class="animate__animated animate__fadeInRight col-span-1 md:col-span-7 p-6 sm:p-12 lg:p-16 flex flex-col justify-center bg-[#0a0a0f]">
            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="text-center md:text-left mb-8">
                    <h1 class="font-serif text-2xl md:text-3xl uppercase tracking-[0.25em] font-bold mb-1 text-white/90">NEW PASSWORD</h1>
                    <div class="w-10 h-[1px] mx-auto md:mx-0 mb-4 gold-bg"></div>
                    <p class="text-white/40 text-xs font-light tracking-wide">Update your credentials to securely re-enter your dashboard.</p>
                </div>
                ...
                <form action="{{ route('user.password.update') }}" method="POST" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="email" name="email" value="{{ request()->email }}" autocomplete="off" required placeholder="name@domain.com"
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-white/60 text-[10px] uppercase tracking-[0.25em] font-medium">New Password</label>
                        <div class="relative w-full">
                            <input type="password" id="password" name="password" required placeholder="••••••••"
                                   class="smooth-transition w-full rounded-xl pl-4 pr-12 py-3 text-white/90 placeholder-white/20 text-sm focus:outline-none focus:ring-0 tracking-wide font-light bg-black/20"
                                   style="border: 1px solid rgba(255,255,255,0.1);"
                                   onfocus="this.style.borderColor='#d4af37'" onblur="this.style.borderColor='rgba(255,255,255,0.1)'">
                            <button type="button" onclick="toggleVisibility('password', 'eyeIcon1')" class="smooth-transition absolute inset-y-0 right-0 pr-4 flex items-center text-white/40 hover:text-gold">
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-white/60 text-[10px] uppercase tracking-[0.25em] font-medium">Confirm Password</label>
                        <div class="relative w-full">
                            <input type="password" id="password_confirmation" name="password_confirmation" required placeholder="••••••••"
                                   class="smooth-transition w-full rounded-xl pl-4 pr-12 py-3 text-white/90 placeholder-white/20 text-sm focus:outline-none focus:ring-0 tracking-wide font-light bg-black/20"
                                   style="border: 1px solid rgba(255,255,255,0.1);"
                                   onfocus="this.style.borderColor='#d4af37'" onblur="this.style.borderColor='rgba(255,255,255,0.1)'">
                            <button type="button" onclick="toggleVisibility('password_confirmation', 'eyeIcon2')" class="smooth-transition absolute inset-y-0 right-0 pr-4 flex items-center text-white/40 hover:text-gold">
                ...
                <div class="text-center md:text-left">
                    <p class="text-white/40 text-xs font-light tracking-wide">
                        Remembered your security passkey? <a href="{{ route('user.login') }}" class="smooth-transition tracking-widest uppercase text-[11px] font-medium ml-1 gold gold-hover">Log In</a>
                    </p>
                </div>
