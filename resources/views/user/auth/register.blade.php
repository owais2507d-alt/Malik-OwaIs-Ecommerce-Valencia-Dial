        ...
        <div class="animate__animated animate__fadeInLeft hidden md:flex md:col-span-5 p-12 lg:p-16 flex-col justify-between relative border-r bg-[#0a0a0f]" style="border-color: rgba(255,255,255,0.05);">
            ...
            <div class="relative z-10 space-y-5 my-auto">
                <h2 class="font-serif text-3xl lg:text-4xl text-white/90 font-medium leading-tight tracking-wide">
                    Experience <br><span class="gold">Excellence</span> <br>In Time.
                </h2>
        ...
        <div class="animate__animated animate__fadeInRight col-span-1 md:col-span-7 p-6 sm:p-12 lg:p-16 flex flex-col justify-center bg-[#0a0a0f]">
            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="text-center md:text-left mb-8">
                    <h1 class="font-serif text-2xl md:text-3xl uppercase tracking-[0.25em] font-bold mb-1 text-white/90">REGISTER</h1>
                    <div class="w-10 h-[1px] mx-auto md:mx-0 mb-4 gold-bg"></div>
                    <p class="text-white/40 text-xs font-light tracking-wide">Enter your credentials to establish a premium presence.</p>
                </div>
                ...
                <form action="{{ url('/register') }}" method="POST" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-white/60 text-[10px] uppercase tracking-[0.25em] font-medium">Full Name</label>
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-white/60 text-[10px] uppercase tracking-[0.25em] font-medium">Password</label>
                ...
                <div class="text-center md:text-left">
                    <p class="text-white/40 text-xs font-light tracking-wide">
                        Already part of the elite? <a href="{{ route('user.login') }}" class="smooth-transition tracking-widest uppercase text-[11px] font-medium ml-1 gold gold-hover">Log In</a>
                    </p>
                </div>
