            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="text-center md:text-left">
                    <p class="text-stone-400 text-xs font-light tracking-wide">
                        Remembered your security passkey? <a href="{{ route('login') }}" class="smooth-transition tracking-widest uppercase text-[11px] font-medium ml-1" style="color: var(--text-gold);" onmouseover="this.style.color='var(--text-gold-hover)'" onmouseout="this.style.color='var(--text-gold)'">Log In</a>
                    </p>
                </div>
