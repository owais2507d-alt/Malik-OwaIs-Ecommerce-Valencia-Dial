            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <form action="{{ url('/login') }}" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between text-xs text-stone-400 pt-1">
                        <label class="flex items-center space-x-2 cursor-pointer select-none">
                            ...
                            <span class="tracking-wide font-light text-[11px] uppercase text-stone-400">Remember my session</span>
                        </label>
                    </div>
                ...
                <div class="text-center md:text-left">
                    <p class="text-stone-400 text-xs font-light tracking-wide">
                        Don't have an account? <a href="{{ route('register') }}" class="smooth-transition tracking-widest uppercase text-[11px] font-medium ml-1" style="color: var(--text-gold);" onmouseover="this.style.color='var(--text-gold-hover)'" onmouseout="this.style.color='var(--text-gold)'">Register</a>
                    </p>
                </div>
