...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-800">New Slide</h2>
        <p class="text-gray-500 mt-1">Add a new carousel slide to the homepage</p>
    </div>
        ...
        <form action="{{ route('admin.slides.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" class="form-input" placeholder="e.g. Timeless Elegance" required>
                    @error('title') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label class="form-label">Subtitle</label>
                    <input type="text" name="subtitle" value="{{ old('subtitle') }}" class="form-input" placeholder="e.g. Since 1987">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="3" class="form-input" placeholder="Slide description...">{{ old('description') }}</textarea>
                    @error('description') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label class="form-label">CTA Text</label>
                    <input type="text" name="cta_text" value="{{ old('cta_text') }}" class="form-input" placeholder="e.g. Shop Now">
